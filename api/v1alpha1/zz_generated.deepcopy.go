...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *YDBConfiguration) DeepCopyInto(out *YDBConfiguration) {
	*out = *in
	out.DomainsConfig = in.DomainsConfig
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new YDBConfiguration.
func (in *YDBConfiguration) DeepCopy() *YDBConfiguration {
	if in == nil {
		return nil
	}
	out := new(YDBConfiguration)
	in.DeepCopyInto(out)
	return out
}
