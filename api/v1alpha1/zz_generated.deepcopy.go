...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DomainsConfig) DeepCopyInto(out *DomainsConfig) {
	*out = *in
	out.SecurityConfig = in.SecurityConfig
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DomainsConfig.
func (in *DomainsConfig) DeepCopy() *DomainsConfig {
	if in == nil {
		return nil
	}
	out := new(DomainsConfig)
	in.DeepCopyInto(out)
	return out
}
