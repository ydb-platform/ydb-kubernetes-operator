...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageUnits) DeepCopyInto(out *StorageUnits) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageUnits.
func (in *StorageUnits) DeepCopy() *StorageUnits {
	if in == nil {
		return nil
	}
	out := new(StorageUnits)
	in.DeepCopyInto(out)
	return out
}
